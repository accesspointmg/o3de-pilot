...
class TestDiscoverModels:
    ...
    @patch("o3de_pilot.ai.provider.ClaudeProvider.list_models")
    ...
    @patch("o3de_pilot.ai.provider.OllamaProvider.list_models")
    ...
    @patch("o3de_pilot.ai.provider.GeminiProvider.list_models")
    ...
    @patch("o3de_pilot.ai.provider.OpenAIProvider.list_models")
    ...
    @patch("o3de_pilot.ai.provider.OpenAICompatibleProvider.list_models")
...
class TestThinkingEffort:
    ...
    def test_base_provider_default_off(self):
        from o3de_pilot.ai.provider import AIProvider
    ...
    def test_claude_thinking_kwargs_low(self):
        from o3de_pilot.ai.provider import ClaudeProvider, _CLAUDE_BUDGET
        p = ClaudeProvider.__new__(ClaudeProvider)
    ...
    def test_openai_reasoning_effort_o_series(self):
        ...
        from o3de_pilot.ai.provider import OpenAIProvider, _OPENAI_EFFORT
    ...
    def test_gemini_body_high(self):
        from o3de_pilot.ai.provider import GeminiProvider, _GEMINI_BUDGET
        p = GeminiProvider.__new__(GeminiProvider)
        p.thinking_effort = "high"
        body = p._gemini_body("hello")
    ...
    @patch("o3de_pilot.core.config.get_config")
...
class TestLocalModel:
    ...
    def test_default_local_model_constant(self):
        from o3de_pilot.ai.provider import DEFAULT_LOCAL_MODEL
        assert ":" in DEFAULT_LOCAL_MODEL  # has explicit tag

    def test_ollama_is_running_true(self):
        from o3de_pilot.ai.provider import _ollama_is_running
    ...
    def test_ollama_has_model_exact(self):
        from o3de_pilot.ai.provider import _ollama_has_model
        mock_resp = MagicMock()
    ...
    def test_ollama_pull_success(self):
        from o3de_pilot.ai.provider import _ollama_pull
    ...
    def test_factory_uses_default_local_model(self, mock_gc):
        from o3de_pilot.ai.provider import get_ai_provider, DEFAULT_LOCAL_MODEL
        cfg = {
            "ai.enabled": "true",
            "ai.provider": "ollama",
