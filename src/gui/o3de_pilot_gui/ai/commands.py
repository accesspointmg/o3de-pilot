...
def _apply_thinking(provider, thinking: str | None):
    ...
    if thinking:
        from .provider import THINKING_LEVELS
...
def setup() -> None:
    ...
    from .provider import OPENAI_COMPATIBLE_URLS
    ...
    if provider_key == "ollama":
        ...
        from .provider import discover_models
...
def models_command(as_json: bool, provider_name: str | None) -> None:
    ...
    from o3de_cli.core.config import get_config
    from .provider import discover_models, OPENAI_COMPATIBLE_URLS
...
def chat() -> None:
    ...
    from .command_router import match_command
...
def voice_status() -> None:
    ...
    from .voice import VoiceConfig, get_stt_provider, get_tts_provider
