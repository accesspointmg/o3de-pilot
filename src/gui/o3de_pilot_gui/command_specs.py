...
COMMAND_SPECS: dict[str, dict] = {
    ...
    "registry login": {
        "cli_args": ["registry", "login"],
        "title": "Login to Registry",
        "description": "Store an auth token for a private registry.",
        "fields": [
            _field("registry_url", "Registry URL", required=True,
                   placeholder="https://registry.example.com", positional=True),
            _field("token", "Auth Token", required=True,
    ...
    "registry logout": {
        "cli_args": ["registry", "logout"],
        "title": "Logout from Registry",
        "description": "Remove a stored auth token for a registry.",
        "fields": [
            _field("registry_url", "Registry URL", required=True,
                   placeholder="https://registry.example.com", positional=True),
        ],
    ...
    "registry whoami": {
        "cli_args": ["registry", "whoami"],
        "title": "Check Auth Status",
        "description": "Check if authenticated with a registry.",
        "fields": [
            _field("registry_url", "Registry URL", required=True,
                   placeholder="https://registry.example.com", positional=True),
        ],
    ...
    "workspace update": {
        ...
        "fields": [
            ...
            _field("attributions", "Overlay Metadata", "choice",
                   choices=["(keep current)", "workspace", "object", "off"],
    ...
    "workspace build": {
        ...
        "fields": [
            ...
            _field("config", "Configuration", "choice",
                   default="profile", choices=["debug", "profile", "release"]),
            _field("target", "Build Target(s)",
                   placeholder="e.g. Editor, MyProject.GameLauncher"),
            _field("engine_centric", "Engine-Centric Build", "flag"),
            _field("configure_only", "Configure Only (skip build)", "flag"),
            _field("reconfigure", "Force Reconfigure", "flag"),
            _field("preset", "CMake Preset",
                   placeholder="e.g. windows-default"),
            _field("parallel", "Parallel Jobs",
                   placeholder="(auto)"),
            _field("generator", "CMake Generator", "choice",
                   choices=["", "auto", "vs", "ninja", "xcode", "makefiles"]),
            _field("dry_run", "Dry Run", "flag"),
            _field("json", "Output as JSON", "flag"),
        ],
        "state_changing": True,
    ...
    "workspace verify-lock": {
        "cli_args": ["workspace", "verify-lock"],
    ...
    "publish pack": {
        "cli_args": ["publish", "pack"],
        "title": "Pack for Distribution",
        "description": "Create a distributable tarball of an object.",
        "fields": [
            _field("path", "Object Path", "path", required=True,
                   from_selected="path"),
            _field("output", "Output File", "path",
                   placeholder="(default: ./<name>-<version>.tar.gz)"),
            _field("json", "Output as JSON", "flag"),
        ],
        "state_changing": True,
        "object_types": [],
    ...
    "audit": {
        ...
        "fields": [
            _field("fix", "Auto-fix Issues", "flag"),
            _field("json", "Output as JSON", "flag"),
        ],
        "state_changing": False,
        "object_types": [],
    ...
    "config get": {
        ...
        "description": "Get a configuration value (or all values if key is empty).",
        "fields": [
            _field("key", "Config Key", positional=True,
                   placeholder="e.g. default_engine_path (empty = show all)"),
            _field("json", "Output as JSON", "flag"),
        ],
        "state_changing": False,
        "object_types": [],
    ...
    "config set": {
        ...
        "fields": [
            _field("key", "Config Key", required=True, positional=True,
                   placeholder="e.g. default_engine_path"),
            _field("value", "Value", required=True, positional=True),
            _field("json", "Output as JSON", "flag"),
        ],
        "state_changing": True,
        "object_types": [],
...
TOOLBAR_GROUPS = [
    ...
    },
    {
        ...
        "commands": [
            ...
            "workspace build",
            "---",
            "workspace lock", "workspace verify-lock",
            "---",
            "workspace delete",
        ],
    },
    {
        ...
        "commands": [
            ...
            "registry list-remotes",
            "---",
            "registry login", "registry logout", "registry whoami",
            "---",
            ...
            "audit",
            "---",
            "publish validate", "publish pack", "publish push",
        ],
    },
    {
        "id": "config",
